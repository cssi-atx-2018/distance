...
china = Country("China", ["Mandarin"], [71], ["Chinese Folk Religion", "Buddhism", "Christianity"], [73.6, 15.9, 2.5],
    ["Han Chinese", "Zhuang", "Hui"], [91.6, 1.2, 0.8], "", "", ["Yuan", "220v", "GMT+8"],
...
["Protestant", "No religion", "Catholic"], [73.2,14.9,7.4], ["Black African", "Coloured", "White", "Indian/Asian"],
[80.2,8.8,8.4,2.5], "", "", ["Rand", "230v", "GMT+2"],["Passport Validity: 30 days", "Blank Passport Pages: 2 consecutive empty pages per entry",
